...
function renderLogo(): Response {
  return htmlPage(
    ...
    `<article class="content-page logo-page">
     <a class="back-link" href="/">トップへ戻る</a>
     <h1>ロゴ</h1>
     <p class="lead">orbskyのブランドマーク。青いリングの中に蝶を配置して「orbsky」の O を表す。リングの色は常に青——ブランドカラーであり、配信状態を示すものではない。配信中は下部に赤い LIVE バッジが重なる。</p>
     ...
     <dl class="logo-specs">
       ...
       <div><dt>蝶</dt><dd>linear-gradient(#7cc0ff, #3d8ced, #2a6ed0)</dd></div>
       <div><dt>LIVEバッジ</dt><dd>linear-gradient(#f0403a, #d0201f)</dd></div>
