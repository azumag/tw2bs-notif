  ...
  return htmlPage(
    ...
    `<article class="focused-page support-page">
       ...
       <section class="focus-card">
         ...
         <h3>なぜチャネル数を制限しているのか</h3>
         <p>連携チャネルが増えるほど、配信状態の監視やBlueskyへの反映にかかるサーバー負荷が積み上がります。1つのチャネルにつき、配信の開始・終了の受信、配信情報の問い合わせ、配信中バッジの維持が継続的に発生するためです。無料で全員が無制限に連携できる形にすると運営を続けられなくなるため、標準は1チャネルとし、支援いただいた方にはその分を上乗せでお返しする形にしています。</p>
       </section>
